	...
	<div class="list_song" style="padding: 0px;">
		<div class="left">
			<div class="left images">
            	<img src="image/giaodien/nhac.png" class="img" height="50%" width="100%">
            </div>
			<p class="song">
		...
		<div class="right list_icon">
			<div class="right-icon">
                <a href="download.php?file=<?php echo $row["duongdan"];?>" title="Tải bài hát <?php echo $row['tenbaihat']; ?> về máy tính">
