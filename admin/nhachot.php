		...
		<div class="block-fluid">                        
			...
			<div class="row-form">
				<table width="348" border="0">
					<tr>
						<td width="187px"><input class="btn btn-large" type="submit" value="Upload" name="ok"></td>
						<td width="8">&nbsp;</td>
					</tr>
				</table>
				<div class="clear"></div>
...
<?php 
	if($_POST['sua'])	
	{
		...
		if($checkbox=='')
		{
			echo '<script type="text/javascript"> alert("Bạn chưa chọn bài hát nào hết!"); </script>';
		}
		else
		{
...
window.onload = externalLinks;
					...
					<table width="348" border="0" pading>
						<tr>
                            <td width="187" ><input class="btn btn-large" type="submit" value="Xóa Luôn" onClick="return confirm('Bạn có chắc chắn muốn xóa bài hát ?');" name="no" ></td>
