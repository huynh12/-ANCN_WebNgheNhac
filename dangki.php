...
<?php
    ...
    $result = mysqli_query($link,$query) or die(mysqli_error($link,$sql));
	...
	else
	{
		...
		else
		{
			...
			$resual=mysqli_query($link,$sql) or die(mysqli_error($link,$sql));
				if($resual)
				{
...
<div id="footer">
        <div class="adv_footer">
            ...
            <div class="footer-info">
                <?php include"form/footer.php";?><!--form footer với webslide khác-->
                              <div class="clr">
                </div>
            </div>
