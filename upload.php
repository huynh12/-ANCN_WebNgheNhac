<?php
	...
	$row=mysqli_fetch_array($sql);
		if(isset($_POST['up']))
		{
			...
			$extent_file="mp3";			//file được phép upload (mp3)
			$pattern='#.+\.(mp3)$#i';
			...
			if($file_type==true)
			{
				//tên của tệp được tải lên trên máy tính
				$source=$_FILES['upload']['tmp_name'];
				// $dest => Vị trí file lưu tạm trong server (file sẽ lưu trong nhac, với tên giống tên ban đầu)
